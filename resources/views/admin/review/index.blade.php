                    ...
                    <div class="rbt-dashboard-content-wrapper">
                        ...
                        <div class="rbt-tutor-information">
                            ...
                            <div class="rbt-tutor-information-right">
                                <div class="tutor-btn">
                                    <a class="rbt-btn btn-third btn-md hover-icon-reverse" href="{{ route('review.trashed') }}">
                                        <span class="icon-reverse-wrapper">
                                            <span class="btn-text">Trashed Review  <i class="feather-trash-2 pl--0"></i></span>
...
{{--                                                                   title="Edit"><i class="feather-edit pl--0"></i></a>--}}
                                                                ...
                                                                <form action="{{ route('review.softdelete',['id'=>$item->id]) }}" method="get">
                                                                    @csrf
