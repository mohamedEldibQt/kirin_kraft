                                ...
                                <div class="content">
                                        ...
                                        <ul class="nav nav-tabs tab-button-style-2 justify-content-start" id="settinsTab-4" role="tablist">
                                            <li role="presentation">
                                                <a href="#" class="tab-button active" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" role="tab" aria-controls="profile" aria-selected="true">
                                                    <span class="title">Update Painting</span>
                                                </a>
                                            </li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade active show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            <form action="{{route('painting.update',['id'=>$painting->id])}}" method="POST" enctype="multipart/form-data" class="rbt-profile-row rbt-default-form row row--15">
                                                @csrf
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="rbt-form-group">
                                                        ...
                                                        <input id="painting_name" name="code" type="text" value="{{$painting->painting_name}}">
                                                    </div>
                                                </div>
...
{{--                                                </div>--}}
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="rbt-form-group">
                                                        ...
                                                        <input id="painting_size" name="painting_size" type="text" value="{{$painting->painting_size}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="rbt-form-group">
                                                        ...
                                                        <input id="painting_colors" name="painting_colors" type="text" value="{{$painting->painting_colors}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="rbt-form-group">
                                                        ...
                                                        <textarea id="painting_description" cols="20" rows="5" name="painting_description"> {{$painting->painting_description}} </textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 mt--20">
                                                    <div class="rbt-form-group">
                                                        <button type="submit" class="rbt-btn btn-gradient" href="#">Update Painting</button>
                                                    </div>
                                                </div>
                                            </form>
                                            <!-- End Profile Row  -->
