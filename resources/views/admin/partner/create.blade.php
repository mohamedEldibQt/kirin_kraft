                                ...
                                <div class="content">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade active show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            <form action="{{route('partner.store')}}" method="POST" enctype="multipart/form-data" class="rbt-profile-row rbt-default-form row row--15">
                                                @csrf
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                                    <div class="rbt-form-group">
                                                        ...
                                                        <input id="partner_name" name="partner_name" type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 mt--20">
                                                    <div class="rbt-form-group">
                                                        <button type="submit" class="rbt-btn btn-gradient" href="#">Create Partner</button>
                                                    </div>
                                                </div>
                                            </form>
                                            <!-- End Profile Row  -->
